...
from mysearch.research import discovery
...
class MySearchClient(ProviderTransport):
    ...
    def _research_known_provider_doc_queries(self, entity: str) -> list[str]:
        return discovery._research_known_provider_doc_queries(entity=entity)
    ...
    def _research_relaxed_discovery_query(self, query: str) -> str:
        return discovery._research_relaxed_discovery_query(query=query)
    ...
    def _research_primary_discovery_route(
        ...
        *,
        ...
        return discovery._research_primary_discovery_route(query=query, mode=mode, intent=intent, authoritative_research=authoritative_research)
    ...
    def _research_prefers_tavily_discovery(
        ...
        *,
        ...
        return discovery._research_prefers_tavily_discovery(query=query, mode=mode, intent=intent, authoritative_research=authoritative_research)

    def _research_known_provider_doc_results(self, query: str) -> list[dict[str, Any]]:
        return discovery._research_known_provider_doc_results(query=query)

    def _research_generic_vendor_doc_results(self, query: str) -> list[dict[str, Any]]:
        return discovery._research_generic_vendor_doc_results(query=query)
    ...
    def _research_prefers_authoritative_sources(
        ...
        *,
        ...
        return discovery._research_prefers_authoritative_sources(query=query, mode=mode, intent=intent, include_domains=include_domains)
